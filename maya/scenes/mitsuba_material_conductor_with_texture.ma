...
file -rdi 2 -ns "Geometry" -rfn "GeometryRN" -op "v=0;" -typ "mayaAscii" "MitsubaSphere.ma";
...
createNode reference -n "mitsuba_material_demo_baseRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"GeometryRN" 4
		3 "|Geometry:MitsubaSphere|Geometry:Mesh1|Geometry:Mesh1Shape.instObjGroups" 
		"MitsubaRoughPlasticShader1SG.dagSetMembers" "-na"
		3 "|Geometry:MitsubaSphere|Geometry:Mesh|Geometry:MeshShape.instObjGroups" 
		"MitsubaRoughPlasticShader1SG.dagSetMembers" "-na"
		5 3 "mitsuba_material_demo_baseRN" "|Geometry:MitsubaSphere|Geometry:Mesh1|Geometry:Mesh1Shape.instObjGroups" 
		"mitsuba_material_demo_baseRN.placeHolderList[1]" "MitsubaRoughPlasticShader1SG.dsm"
		
		5 3 "mitsuba_material_demo_baseRN" "|Geometry:MitsubaSphere|Geometry:Mesh|Geometry:MeshShape.instObjGroups" 
		"mitsuba_material_demo_baseRN.placeHolderList[2]" "MitsubaRoughPlasticShader1SG.dsm";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode MitsubaRenderSettings -s -n "defaultMitsubaRenderGlobals";
	rename -uid "36512E1E-DC46-9E3F-63C0-978FB5C6A899";
	setAttr ".sc" 512;
	setAttr ".kt" yes;
...
select -ne :defaultRenderGlobals;
	setAttr ".ren" -type "string" "Mitsuba";
