...
class ward(OpenMayaMPx.MPxNode):
    def __init__(self):
        ...
        mAlphaU = OpenMaya.MObject()
        mAlphaV = OpenMaya.MObject()
...
def nodeInitializer():
    ...
    try:
        ...
        ward.mAlphaU = nAttr.create("alphaU","au", OpenMaya.MFnNumericData.kFloat)
        nAttr.setKeyable(1) 
        nAttr.setStorable(1)
        nAttr.setReadable(1)
        nAttr.setWritable(1)
        ...
        ward.mAlphaV = nAttr.create("alphaV","av", OpenMaya.MFnNumericData.kFloat)
        nAttr.setKeyable(1) 
        nAttr.setStorable(1)
        nAttr.setReadable(1)
        nAttr.setWritable(1)
    ...
    try:
        ...
        ward.addAttribute(ward.mAlphaU)
        ward.addAttribute(ward.mAlphaV)
