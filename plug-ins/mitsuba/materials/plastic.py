...
def nodeInitializer():
    ...
    try:
        ...
        plastic.mInteriorMaterial = eAttr.create("interiorMaterial", "intmat")
        eAttr.setKeyable(1) 
        eAttr.setStorable(1)
        eAttr.setReadable(1)
        eAttr.setWritable(1)
        ...
        plastic.mExteriorMaterial = eAttr.create("exteriorMaterial", "extmat")
        eAttr.setKeyable(1) 
        eAttr.setStorable(1)
        eAttr.setReadable(1)
        eAttr.setWritable(1)
    ...
    try:
        ...
        plastic.addAttribute(plastic.mInteriorMaterial)
        plastic.addAttribute(plastic.mIntIOR)
        plastic.addAttribute(plastic.mExteriorMaterial)
        plastic.addAttribute(plastic.mExtIOR)
        plastic.addAttribute(plastic.mNonLinear)
