...
def nodeInitializer():
    ...
    try:
        difftrans.mTransmittance = nAttr.createColor("transmittance", "tr")
        nAttr.setKeyable(1) 
        nAttr.setStorable(1)
        nAttr.setReadable(1)
        nAttr.setWritable(1)
    ...
    try:
        difftrans.addAttribute(difftrans.mTransmittance)
    ...
    try:
        difftrans.attributeAffects (difftrans.mTransmittance, difftrans.mOutColor)
    except:
